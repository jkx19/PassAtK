...
python3 grader.py --dataset ${dataset} --input_file ${prediction_w_rm_score_file} --pass_at ${K} --num_samples ${Sample_N} --real_N ${Real_N} --threading ${num_threads} --output_file ${different_answers_file} --method softBoN
