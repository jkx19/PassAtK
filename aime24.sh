...
N=1000
K=40
inference_output_file="output/qwen2.5_1.5b_${dataset}_${N}.json"
...
python3 reward.py --model_name ${reward_model_name} --dataset ${dataset} --num_samples_per_task ${N} --input_file ${inference_output_file} --output_file ${prediction_w_rm_score_file}
